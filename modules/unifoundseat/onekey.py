...
async def scanseat(app: Ariadne, friend: Union[Friend,Stranger], cmd: RegexResult, seatname: RegexResult):
    await reserve(app,friend,cmd,seatname)
    await autosign(app,friend)
    
    

async def autosign(app: Ariadne, friend: Union[Friend,Stranger]):
...
async def reserve(app: Ariadne, friend: Union[Friend,Stranger], cmd: RegexResult, seatname: RegexResult):
    loop = asyncio.get_running_loop()
